<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NominateHeroThankYou.aspx.cs" Inherits="NominateHeroThankYou" %>
			...
			<div id="head">
				...
				<div id="menuBar">
					<ul id="mainMenu">
						...
						<li id="menuFireSafetyTips"><a href="fireSafetyTips.html"><em>Fire Safety Tips</em></a></li>
...
Aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui.</p>
                <asp:HyperLink ID="HyperLink1" NavigateUrl="beAHomeHero.html" runat="server">Back to HomeHero&trade;</asp:HyperLink>
			</div>
